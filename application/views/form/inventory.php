...
foreach ($b_inv as $item) {	
	if ($item['options'] == 1 && $item['items_group_id'] == 1) {
			echo form_radio(array('name' => 'inv[1]', 'value' =>$item['name']));
...
foreach ($b_inv as $item) {	
	if ($item['options'] == 1 && $item['items_group_id'] == 2) {
			echo form_radio(array('name' => 'inv[2]', 'value' =>$item['name']));
			echo form_label($item['item']);
			echo br();
	}
}
foreach ($b_inv as $item) {	
	if ($item['options'] == 1 && $item['items_group_id'] == 3) {
			echo form_radio(array('name' => 'inv[3]', 'value' =>$item['name']));
			echo form_label($item['item']);
			echo br();
	}
}
foreach ($b_inv as $item) {	
	if ($item['options'] == 1 && $item['items_group_id'] == 4) {
			echo form_radio(array('name' => 'inv[4]', 'value' =>$item['name']));
			echo form_label($item['item']);
			echo br();
	}
}
foreach ($b_inv as $item) {	
	if ($item['options'] == 1 && $item['items_group_id'] == 5) {
			echo form_radio(array('name' => 'inv[5]', 'value' =>$item['name']));
			echo form_label($item['item']);
			echo br();
	}
}
